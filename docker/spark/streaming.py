...
#     .config("google.cloud.auth.service.account.json.keyfile", credentials_location)
#     .getOrCreate()
# )
spark = (
    SparkSession.builder.appName("KafkaStreaming")
...
spark.conf.set("spark.sql.shuffle.partitions", 5)  # for small local machine
...
df = (
    ...
    .option("subscribe", "message_data")
    .option("startingOffsets", "latest")
    .load()
)

# 解碼 Kafka 消息的 value 部分，並將其轉換為字符串
